...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/08/11 12:22:32 by phsottat          #+#    #+#             */
/*   Updated: 2026/08/11 12:22:33 by phsottat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int len, char **str)
{
	size_t			col = 8;
	t_2intlist		intlist;
	int				intarr[] = {3	,27	,70	,99	,3	,91	,39,	79};
	int				*temp_intarr;
	int				*sorted_intarr;
...
/*
valgrind --leak-check=full --show-leak-kinds=all ./unit_test/out/turk_sort/turk_sort_08_04.out
*/
