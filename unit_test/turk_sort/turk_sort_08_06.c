...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/08/11 12:22:40 by phsottat          #+#    #+#             */
/*   Updated: 2026/08/11 12:22:41 by phsottat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int len, char **str)
{
	size_t			col = 8;
	t_2intlist		intlist;
	int				intarr[] = {94	,4	,18	,11	,51	,91	,69,	51};
	int				*temp_intarr;
	int				*sorted_intarr;
...
/*
valgrind --leak-check=full --show-leak-kinds=all ./unit_test/out/turk_sort/turk_sort_08_06.out
*/
