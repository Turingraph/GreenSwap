...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/08/11 12:22:48 by phsottat          #+#    #+#             */
/*   Updated: 2026/08/11 12:22:49 by phsottat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int len, char **str)
{
	size_t			col = 8;
	t_2intlist		intlist;
	int				intarr[] = {98	,31	,28	,12	,25	,68	,77,	83};
	int				*temp_intarr;
	int				*sorted_intarr;
	...
	sorted_intarr = merge_sort(temp_intarr, col);
	intlist = load_2intlist(intarr, col);
	turk_cost = debug_turk_sort(&intlist, -2, 2);
	if (is_intarr_and_list_same(sorted_intarr, intlist.a.item_1st, col, true) == true)
		write(1, "Correct\n", 9);
	else
	{
...
/*
valgrind --leak-check=full --show-leak-kinds=all ./unit_test/out/turk_sort/turk_sort_08_08.out
*/
