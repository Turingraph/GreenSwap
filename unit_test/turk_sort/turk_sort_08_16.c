...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/08/11 12:23:14 by phsottat          #+#    #+#             */
/*   Updated: 2026/08/11 12:23:15 by phsottat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int len, char **str)
{
	size_t			col = 8;
	t_2intlist		intlist;
	int				intarr[] = {68	,59	,82	,36	,73	,66	,22,	36};
	int				*temp_intarr;
	int				*sorted_intarr;
...
/*
valgrind --leak-check=full --show-leak-kinds=all ./unit_test/out/turk_sort/turk_sort_08_16.out
*/
